...
public class TriangleCollection {
    ...
    public void shiftTriangles(int increment) {
      /* IMPLEMENT ME */
      for (int i = 0; i < collection.length; i++){
        collection[i].setVertices(increment);
      }
    }
    ...
    public String triangleCollectionInfo() {
      ...
      for (int i = 0; i < collection.length; i++){
        triangles += collection[i].triangleInfo();
        triangles += "\n";
      }
      return triangles;
    }
    ...
    public static void main(String[] args) {
        TriangleCollection test = new TriangleCollection(3, 2, 5);
        System.out.println(test.triangleCollectionInfo());
    }
  }
